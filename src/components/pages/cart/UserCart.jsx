...
const UserCart = () => {
  return (
    <div className="shopping-cart" style={{ direction: "rtl" }}>
      <div className="px-4 px-lg-0">
        <div className="pb-5">
          <div className="container">
            <div className="row">
              <div className="col-lg-12 p-5 bg-white rounded shadow-sm mb-5 text-center">
                <div className="table-responsive">
                  <table className="table">
                    <thead>
                      <tr>
                        <th scope="col" className="border-0 bg-light">
                          <div className="p-2 px-3 text-uppercase">محصول</div>
                        </th>
                        <th scope="col" className="border-0 bg-light">
